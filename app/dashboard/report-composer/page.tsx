    ...
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="flex items-center h-12 px-4 border-b gap-2">
        <div className="flex items-center gap-2 border-none">
          <div className="flex items-center border rounded px-2 py-1 text-sm bg-white">
            <span>Paragraph</span>
          </div>
          <div className="flex items-center border rounded px-2 py-1 text-sm bg-white">
            <span>Lausanne</span>
        ...
        <div className="flex items-center gap-2 ml-auto">
          <Button variant="ghost" size="sm" className="text-sm">Aa</Button>
        </div>
      </div>
          ...
          <div className="p-4 flex flex-col h-full">
            <div className="text-sm text-gray-500 mb-2 flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <button className="p-1 opacity-50">+</button>
                <button className="p-1 opacity-50">⌚</button>
                <button className="p-1 opacity-50">...</button>
                <button className="p-1 opacity-50">×</button>
              </div>
